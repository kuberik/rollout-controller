...
func (in *BlockedRelease) DeepCopyInto(out *BlockedRelease) {
	*out = *in
	if in.RequiredVersion != nil {
		in, out := &in.RequiredVersion, &out.RequiredVersion
		*out = new(string)
		**out = **in
	}
}
...
func (in *ClusterRolloutSchedule) DeepCopy() *ClusterRolloutSchedule {
	...
	out := new(ClusterRolloutSchedule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterRolloutScheduleList) DeepCopyInto(out *ClusterRolloutScheduleList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ClusterRolloutSchedule, len(*in))
		for i := range *in {
...
func (in *ClusterRolloutScheduleList) DeepCopy() *ClusterRolloutScheduleList {
	...
	out := new(ClusterRolloutScheduleList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterRolloutScheduleSpec) DeepCopy() *ClusterRolloutScheduleSpec {
	...
	out := new(ClusterRolloutScheduleSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterRolloutScheduleStatus) DeepCopyInto(out *ClusterRolloutScheduleStatus) {
	*out = *in
	...
	if in.ManagedGates != nil {
		in, out := &in.ManagedGates, &out.ManagedGates
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *ClusterRolloutScheduleStatus) DeepCopy() *ClusterRolloutScheduleStatus {
	...
	out := new(ClusterRolloutScheduleStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DeploymentHistoryEntry) DeepCopyInto(out *DeploymentHistoryEntry) {
	*out = *in
	...
	if in.FailedHealthChecks != nil {
		...
		*out = make([]FailedHealthCheck, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ProviderRolloutReference) DeepCopy() *ProviderRolloutReference {
	...
	out := new(ProviderRolloutReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RolloutDependencyList) DeepCopyInto(out *RolloutDependencyList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RolloutDependency, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RolloutDependencyStatus) DeepCopyInto(out *RolloutDependencyStatus) {
	*out = *in
	...
	if in.ProvidedVersion != nil {
		in, out := &in.ProvidedVersion, &out.ProvidedVersion
		*out = new(string)
		**out = **in
	}
	if in.ProvidedTag != nil {
		in, out := &in.ProvidedTag, &out.ProvidedTag
		*out = new(string)
		**out = **in
	}
	if in.AdmittedVersions != nil {
		in, out := &in.AdmittedVersions, &out.AdmittedVersions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.BlockedReleases != nil {
		in, out := &in.BlockedReleases, &out.BlockedReleases
		*out = make([]BlockedRelease, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *RolloutDependencyStatus) DeepCopy() *RolloutDependencyStatus {
	...
	out := new(RolloutDependencyStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RolloutScheduleList) DeepCopyInto(out *RolloutScheduleList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RolloutSchedule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
