...
- Exit immediately when a watched CRD is missing, instead of reporting ready for two minutes and then crashlooping (#52)

## [0.9.1] - 2026-09-10

### Fixed

- Recognise a build ordinal that carries a short commit hash (#51)
...
- Enrich health status messages and fix bake time boundary check (#40)

- Prefer Stalled=True as failure witness, fall back to newest condition (#45)

- Skip not-found managed resources in kustomization health check

- Requeue manual deployments when bakeStatus is Deploying (#46)

## [0.7.0] - 2026-02-04

### Added

- Implement RolloutSchedule and ClusterRolloutSchedule (#38)
